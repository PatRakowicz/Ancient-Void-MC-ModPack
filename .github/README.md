...
To have it load on twitch, open the `Dev` folder and run the `setup.bat` It should download and load anything nessessary and will show up on your twitch launcher.
